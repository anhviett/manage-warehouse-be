<template>
    <el-dialog v-model="dialogProductView" title="Xem thông tin phiếu nhập" width="1100" destroy-on-close>
        ...
        <el-form :model="viewForm" label-width="140px" class="receipt-form">
            <el-row :gutter="16">
                ...
                <el-col :xs="24" :md="12">
                    <el-form-item label="Trạng thái">
                        <el-select v-model="viewForm.is_active" placeholder="Chưa chọn trạng thái" style="width: 100%">
                ...
                <el-col :xs="24" :md="12">
                    <el-form-item label="Tạo lúc">
                        <el-date-picker v-model="viewForm.created_at" type="datetime" placeholder="Pick a Date"
                            format="DD/MM/YYYY HH:mm:ss" value-format="DD/MM/YYYY HH:mm:ss" style="width: 100%" />
                    </el-form-item>
                </el-col>
                <el-col :xs="24" :md="12">
                ...
                <el-col :xs="24">
                    <el-form-item label="Ghi chú">
                        <el-input v-model="viewForm.note" type="textarea" :rows="3" placeholder="Chưa có ghi chú"
                            readonly />
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <div v-for="(item, index) in productItems" :key="item.id || index" class="item-card">
                ...
                <el-row :gutter="16">
                    ...
                    <el-col :xs="24">
                        <el-form-item label="Ghi chú dòng" label-width="120px">
                            <el-input :model-value="item.name || ''" type="textarea" :rows="2"
                                placeholder="Không có ghi chú" readonly />
                        </el-form-item>
                    </el-col>
                </el-row>
            </div>

            <el-empty v-if="!loading && productItems.length === 0" description="Không có sản phẩm nào từ database" />
        ...
        <template #footer>
            <div class="dialog-footer">
                <el-button @click="dialogProductView = false">Đóng</el-button>
            </div>
        </template>
    </el-dialog>
</template>
...
const dialogProductView = defineModel<boolean>('dialogProductView', {
    default: false,
})
interface Props {
    error?: boolean;
...
const { product } = useWareHouseProduct();
const viewForm = product.value;
</script>
